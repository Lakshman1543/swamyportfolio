    ...
    >
      <div className="text-center z-10">
        <div className="mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-light text-gray-300 mb-6 stagger-item">
            {titles[currentTitleIndex]}
          </h2>
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed stagger-item">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8 stagger-item">
          <a
            ...
            download
          >
            <button className="btn-neon text-white px-8 py-4 rounded-lg font-medium transition-all duration-500 hover:scale-110">
